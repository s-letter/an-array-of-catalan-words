...
Llista de ~869.500 paraules en català.
...
(`[a-zçàèéíïòóúü]`) que contenen almenys una vocal. Els acrònims, les abreviatures i els noms propis estan explícitament exclosos.
...
- **Paraules**: ~869.500 paraules úniques en català i en minúscules
- **Filtre**: Només caràcters que coincideixen amb `/^[a-zçàèéíïòóúü]+$/` que contenen almenys una vocal. S'exclouen els acrònims, les abreviatures i els noms propis.
